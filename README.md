...
- Можете использовать свои файлы с прайс-листом и шаблоном, для этого необходимо создать файл `.env`:
```
WINE_PRICE=~/Downloads/вина.xlsx
WINE_TEMPLATE=my_template.html
```
